...
cp /eos/uscms/store/group/cmstestbeam/${BASE}/Tracks/v1/Run$1_CMSTiming_FastTriggerStream_converted.root .
cp /eos/uscms//store/group/cmstestbeam/${BASE}//ConfigInfo/Runs/info_$1.json .
ls
./NetScopeStandaloneDat2Root --input_file=converted_run$1.root --pixel_input_file=/eos/uscms//store/group/cmstestbeam/${BASE}/Tracks/v1/Run$1_CMSTiming_FastTriggerStream_converted.root  --config=LecroyScope_$2.config --output_file=out_run$1.root --save_meas --correctForTimeOffsets=true
